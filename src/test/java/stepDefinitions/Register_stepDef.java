...
public class Register_stepDef {
	...
	public void user_navigates_to_register_account_page() {
	   ...
	   loginPage.selectRegisterOption();
	}
	...
	public void user_enters_the_details_into_below_fields(DataTable dataTable) throws InterruptedException {
		...
		registerPage.enterEmailAddress(commonPage.getEmailWithTimeStamp()); //random emailID will be created
		Thread.sleep(3000);
	...
	public void user_account_should_get_created_successfully() throws InterruptedException {
		Assert.assertEquals("Your Account Has Been Created!", registerPage.getPageHeading());
		Thread.sleep(3000);
	}
	...
	public void user_should_get_a_proper_warning_about_duplicate_email(String text) throws Throwable {
