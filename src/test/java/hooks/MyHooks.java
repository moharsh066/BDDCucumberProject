...
import io.cucumber.java.Scenario; // for 'scenario' interface
...
public class MyHooks {
	...
	private void configureDriver() {
		...
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(CommonUtils.PAGE_LOAD_TIM));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(CommonUtils.IMPLICIT_WAIT_TIM));
	}
